...
const nav = [
  ...
  { href: "/dashboard/patients", label: "Patients", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
...
export function Sidebar() {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 z-40 h-screen border-r border-[var(--card-border)] bg-[var(--sidebar)] shadow-soft transition-[width] duration-200 ${
        collapsed ? "w-20" : "w-56"
      }`}
    >
      <div className="flex h-full flex-col">
        <div className={`flex h-16 items-center border-b border-[var(--card-border)] ${collapsed ? "justify-center px-0" : "gap-2 px-5"}`}>
              ...
              <Link
                ...
                className={`flex items-center rounded-xl text-sm font-medium transition-colors ${
                  ...
                  isActive
                    ...
                    : "text-[var(--foreground)] opacity-90 hover:bg-[var(--sidebar-hover)] hover:opacity-100"
                }`}
              >
        ...
        <div className="border-t border-[var(--card-border)] p-3">
          {collapsed ? (
            <button
              ...
              className="flex w-full justify-center rounded-xl p-2.5 text-[var(--foreground)] opacity-70 hover:bg-[var(--sidebar-hover)] hover:opacity-100"
            ...
            <>
              <p className="px-3 text-xs text-[var(--foreground)] opacity-60">Clinic Dashboard v1</p>
              <button
                type="button"
                onClick={() => setCollapsed(true)}
                className="mt-2 flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm text-[var(--foreground)] opacity-70 hover:bg-[var(--sidebar-hover)] hover:opacity-100"
